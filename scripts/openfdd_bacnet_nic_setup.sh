...
echo "  docker compose --env-file .env up --build"
echo
echo "For live OT LAN BACnet on Linux, prefer:"
echo "  docker compose -f docker-compose.yml -f docker-compose.bacnet-live.yml --env-file .env up --build"
