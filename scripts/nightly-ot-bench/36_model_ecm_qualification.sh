...
USER_A="${OPENFDD_OPS_A_USER:-${OPENFDD_USER_A_OPS_USER:-acme-ops}}"
PASS_A="${OPENFDD_OPS_A_PASSWORD:-${OPENFDD_USER_A_OPS_PASSWORD:-}}"
USER_B="${OPENFDD_OPS_B_USER:-${OPENFDD_USER_B_OPS_USER:-b100-ops}}"
PASS_B="${OPENFDD_OPS_B_PASSWORD:-${OPENFDD_USER_B_OPS_PASSWORD:-}}"
