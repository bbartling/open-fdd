...
| **U-F — Modeling, engineering and twins** | Data-model/PyPI/product maintainer | PARTIAL | Gate 36 FQ CLOSED on hub tip; Soft-OPEN: DM-09 PERF + edge DM-10 projection; EQ-VOCAB/ECM-ADAPT on PyPI tip 4.4.7 (W4); MT breadth. |
...
| **V5** | S5 DM-07..10 / EQ-VOCAB / ECM-ADAPT / Pages | **PARTIAL** (DM-07/08 + Pages); **W4 tip** closes EQ-VOCAB + ECM-ADAPT; residual DM-09 PERF + edge DM-10 | DM-09 · edge DM-10 | [wave_u_v5_s5_dm_ecm.plan.md](.cursor/plans/wave_u_v5_s5_dm_ecm.plan.md) |
