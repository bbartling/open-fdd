...
COOKBOOK_PATTERNS: dict[str, str] = {
    ...
    "custom_evaluate": "Site-specific evaluate() logic in rules_py",
    ...
    "AHU": {
        ...
        "codes": [
            ...
            _code(
                ...
                cookbook_patterns=["custom_evaluate"],
            ),
            _code(
            ...
            _code(
                ...
                cookbook_patterns=["custom_evaluate", "oob_rolling"],
            ),
            _code(
    ...
    "VAV": {
        ...
        "codes": [
            ...
            _code(
                ...
                cookbook_patterns=["spread_1h", "custom_evaluate"],
            ),
        ],
    },
    "HEATPUMP": {
