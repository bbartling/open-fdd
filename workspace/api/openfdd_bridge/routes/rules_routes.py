...
from ..rule_kit import RuleKitError, build_all_rules_export_zip, build_equipment_rule_kit_zip, build_rule_kit_zip, ingest_uploaded_rule
...
@router.get("/export-equipment-kit")
def export_equipment_rule_kit(
    ...
    """Download zip for one equipment: applicable rules, samples, manifest."""
    try:
        payload, filename = build_equipment_rule_kit_zip(
            site_id=site_id,
