...
| **Follow-on tip (not OPS PINNED)** | **3.5.50** mechanical_cooling wall timeout (this PR) · prior 3.5.49 SQL-only timeout insufficient when scan hangs · prior **3.5.48** / `sha-7a0e34e` runtime · hub under test **3.5.47** / `sha-cc23e89` · OPS still `sha-7ad6479` / 3.5.43 until W7 FQ · [wave_u_post-fq_remainder.plan.md](../../.cursor/plans/wave_u_post-fq_remainder.plan.md) |
