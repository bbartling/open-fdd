...
| **acme-afdd-continuous-off** | **Soft-OPEN** · Hub continuous AFDD still **off** until Railway pin (`MODE=continuous`, ACME, 1440/24h) + gate 38 MEGA. ACME is the continuous-AFDD qual building (not Synthetic-59 flood). |
