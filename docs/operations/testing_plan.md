...
This is the evolving engineering plan for Open-FDD automated testing and the optional **OpenClaw lab** bench under [`openclaw/README.md`](https://github.com/bbartling/open-fdd/tree/main/afdd_stack/openclaw/README.md).
...
Or on Windows: [`openclaw/windows/run_daytime_short_suite.cmd`](https://github.com/bbartling/open-fdd/tree/main/afdd_stack/openclaw/windows/run_daytime_short_suite.cmd) (edit URLs first).
