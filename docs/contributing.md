...
**Dev lifecycle:** For branching, version bumps, and clean Docker rebuilds (including nuclear prune), see [CONTRIBUTING.md](https://github.com/bbartling/open-fdd/blob/master/CONTRIBUTING.md).
