...
1. **Fake BACnet device schedule is known**
   - use the deterministic schedules in [`openclaw/bench/fake_bacnet_devices/README.md`](https://github.com/bbartling/open-fdd/tree/main/afdd_stack/openclaw/bench/fake_bacnet_devices/README.md)
...
3. **Open-FDD graph confirms BACnet addressing is modeled correctly**
   ...
   - use the SPARQL assets in [`openclaw/bench/sparql/README.md`](https://github.com/bbartling/open-fdd/tree/main/afdd_stack/openclaw/bench/sparql/README.md)
