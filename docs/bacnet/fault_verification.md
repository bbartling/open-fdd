...
1. **Fake BACnet device schedule is known**
   - use the deterministic schedules in [`openclaw/bench/fake_bacnet_devices/`](../../openclaw/bench/fake_bacnet_devices/)
...
3. **Open-FDD graph confirms BACnet addressing is modeled correctly**
   ...
   - use the SPARQL assets in [`openclaw/bench/sparql/`](../../openclaw/bench/sparql/)
