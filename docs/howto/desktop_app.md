...
The **built-in AI agent** (Codex) is instructed to write **new** code under **`workspace/scratch/`**; see **[Skills and agent shell](skills_and_agent)** for the current layout.
