...
Expressions use raw column values. **0–1 vs 0–100** command scaling is your responsibility unless you call **`normalize_cmd(...)`** in the expression (see [YAML expression cookbook](../expression_rule_cookbook_yaml#signal-scaling-0--1-fraction-vs-0--100-percent)).
