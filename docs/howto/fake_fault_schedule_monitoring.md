...
This page explains the right way to interpret spikes from the Open-FDD **fake BACnet bench** ([`openclaw/bench/fake_bacnet_devices`](../../openclaw/bench/fake_bacnet_devices)).
...
- [`openclaw/bench/fake_bacnet_devices/README.md`](../../openclaw/bench/fake_bacnet_devices/)
