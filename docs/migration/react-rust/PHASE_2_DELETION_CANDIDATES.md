...
|---|---|---|
| P2-DEL-01 UI analytics twin | `frontend/web/app/analytics.py`, `analytics_baseline.py`, `ui_analytics.py`, `metering.py`, `load_satisfaction.py`, `runtime_intervals.py` | **Bundle into Prompt 7** (P2-M5 closeout) |
...
| P2-DEL-07 React product removal | `frontend/web App.tsx`, `frontend/web/requirements.txt`, `openfdd-web` image/compose | **Next PR** after P2-M5 closeout |
| P2-DEL-08 pandas FDD gate removal | `frontend/web/app/rules/**`, `OPENFDD_ALLOW_PANDAS_FDD` | Prod images only; oracle retained |
