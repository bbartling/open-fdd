...
| `UTIL-INTERVAL` | BAS 15m vs utility interval (MAE threshold) | `—` | `util_interval_fault.sql` | `sql_screening` | `none` |
| `UTIL-MONTHLY` | BAS monthly kWh vs utility monthly bills (% deviation) | `—` | `util_monthly_fault.sql` | `sql_screening` | `none` |
