...
- [Secrets and auth](../security/secrets-auth) — required production variables
- [Logging and audit](../ops/logging) — `OFDD_LOG_*` detail
- [JSON API driver](../drivers/json-api) — `${ENV:VAR}` pattern
- [Configuration reference](configuration) — bridge runtime flags not in env files
