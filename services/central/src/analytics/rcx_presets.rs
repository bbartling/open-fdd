...
pub const RCX_PRESETS: &[RcxPresetMeta] = &[
    ...
    RcxPresetMeta {
        id: "ahu_motor_weekly",
        title: "AHU — weekly motor / supply-fan hours",
        family: "AHU / air",
        chart: "overview_analytics",
        role_col: "fan_status",
        eq_kinds: &["AHU", "RTU", "MAU"],
        overlay_col: None,
        pair_return_col: None,
    ...
    RcxPresetMeta {
        id: "economizer_delta",
        title: "AHU — economizer free-cooling delta scatter",
        family: "AHU / air",
        chart: "overview_analytics",
        role_col: "mat",
        eq_kinds: &["AHU", "RTU"],
    ...
    RcxPresetMeta {
        id: "economizer_mat_resid",
        title: "AHU — MAT residual vs ideal mixing",
        family: "AHU / air",
        chart: "overview_analytics",
        role_col: "mat",
        eq_kinds: &["AHU", "RTU"],
    ...
    RcxPresetMeta {
        id: "economizer_temps_overlay",
        title: "AHU — free-cooling temps + OA damper overlay",
        family: "AHU / air",
        chart: "overview_analytics",
        role_col: "oa_damper_pct",
        eq_kinds: &["AHU", "RTU"],
    ...
    RcxPresetMeta {
        id: "boiler_motor_weekly",
        title: "Boiler — weekly HW pump motor hours",
        family: "Boiler / HW",
        chart: "overview_analytics",
        role_col: "hw_pump_status",
        eq_kinds: &["BOILER"],
        overlay_col: None,
        pair_return_col: None,
        filter_fan_on: false,
    ...
    RcxPresetMeta {
        id: "chiller_motor_weekly",
        title: "Chiller — weekly plant motor hours",
        family: "Chiller / CHW / tower",
        chart: "overview_analytics",
        role_col: "chw_pump_status",
        eq_kinds: &["CHILLER", "CHW"],
        overlay_col: None,
        pair_return_col: None,
        filter_fan_on: false,
    ...
    RcxPresetMeta {
        id: "mech_cooling_oat_bins",
        title: "Chiller — mechanical cooling hours by OAT bin",
        family: "Chiller / CHW / tower",
        chart: "overview_analytics",
        role_col: "oa_t",
        eq_kinds: &["CHILLER", "AHU", "HP"],
        overlay_col: None,
        pair_return_col: None,
        filter_fan_on: false,
        prefer_wetbulb: false,
    ...
    RcxPresetMeta {
        id: "bas_vs_web_oat",
        title: "Weather — BAS vs web outdoor-air temperature",
        family: "Weather",
        chart: "overview_analytics",
        role_col: "oa_t",
        eq_kinds: &["WEATHER", "AHU"],
        overlay_col: None,
        pair_return_col: None,
        filter_fan_on: false,
        prefer_wetbulb: false,
...
pub async fn run_preset(
    ...
    if meta.chart == "overview_analytics" {
        return Ok(Some(empty_stub(
            meta,
            "Use Overview analytics POSTs (runtime / mechanical-cooling / economizer / bas-vs-web-oat) — SPA RCx page intercepts this preset",
        )));
    }
