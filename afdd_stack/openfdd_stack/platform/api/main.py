...
def capabilities():
    """
    Return version and feature flags. Live event fan-out moves to **VOLTTRON pub/sub** on the edge;
    this API no longer exposes **/ws/events**. Fault state, jobs, and BACnet proxy routes may still
    be used where the stack is deployed with a BACnet gateway.
