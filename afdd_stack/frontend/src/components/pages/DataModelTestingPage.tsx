  ...
  return (
    <div>
      ...
      <p className="mb-8 text-sm text-muted-foreground">
        Run predefined summary queries or your own SPARQL against the current Brick graph (Brick Schema <strong>1.4</strong>-style class IRIs). Preset buttons use vetted <code className="rounded bg-muted px-1 font-mono text-xs">brick:Class</code> names — see{" "}
      ...
      <Card className="mb-8 border-primary/20 bg-primary/5">
        ...
        <CardContent>
          <label className="mb-3 flex cursor-pointer items-center gap-2 text-sm text-muted-foreground">
            ...
            />
            <span>Include device and object identifiers when present in the graph (for telemetry alignment)</span>
          </label>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            {includeBacnetRefs
              ? "With the box checked, results include device and object identifier columns for each point when those triples exist."
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <p className="text-sm font-normal text-muted-foreground">
            Run a SPARQL query against the current Brick graph. Upload a .sparql file or type below. Results appear below.
          </p>
        </CardHeader>
