...
**Current ops pin (2026-09-11):** VERSION **3.5.5** · tip **`sha-c5b3ccc`** · health **`3.5.5+c5b3ccc947c8`** · `multi_tenant=false` · `active_tenant_id=legacy` · `tenant_budgets=false` · Wave L **L5 LIVE**. Rollback: Wave K **`sha-9c3e8b1`** / **3.4.0**. Prior product L5 **`sha-ecd97a4`**; prior L4 **`sha-d67d27b`**. Low-RAM always (rule 0).
