...
**Current ops pin (2026-09-14):** VERSION **3.5.9** · tip **`sha-1f94cdf`** · health **`3.5.9+1f94cdf06f3e`** · `multi_tenant=true` (authorized Stage C early waiver) · Wave N **OPS PINNED** (ACME MQTTS + ACL list/select PASS; **3.5.10** ships data-path `allow_building` on FDD/CSV/analytics). Rollback: Wave M **`sha-0bfcd81`** / **3.5.7** or Wave L **`sha-e80237c`** / **3.5.6**. Low-RAM always (rule 0).
