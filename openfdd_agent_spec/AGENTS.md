...
**Current ops pin (2026-09-11):** VERSION **3.5.3** · tip **`sha-d67d27b`** · health **`3.5.3+d67d27b9e791`** · `multi_tenant=false` · `active_tenant_id=legacy` · Wave L **L4 LIVE**. Rollback: Wave K **`sha-9c3e8b1`** / **3.4.0**. Prior L3 **`sha-be65366`**. Low-RAM always (rule 0).
