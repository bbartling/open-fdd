...
**Current ops pin (2026-09-11):** VERSION **3.5.5** · tip **`sha-ecd97a4`** · health **`3.5.5+ecd97a473405`** · `multi_tenant=false` · `active_tenant_id=legacy` · `tenant_budgets=false` · Wave L **L5 LIVE**. Rollback: Wave K **`sha-9c3e8b1`** / **3.4.0**. Prior L4 **`sha-d67d27b`**. Low-RAM always (rule 0).
