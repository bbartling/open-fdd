...
**Current ops pin (2026-09-19):** VERSION **3.5.31** · tip **`sha-7b81eb8`** · health **`3.5.31+7b81eb810c0f`** · `multi_tenant=true` · backup **`20260919T193923Z`** · hub stress **`reports/nightly-ot-bench_20260919T195100Z/`** **`fully_qualified=true`** (gates **19**+**35**+**25**/**25b** with `OPENFDD_SECURITY_EXECUTE=1`, live edge **`vim-1`**) · **OPS PINNED** (Wave S1). Prior: **`sha-f727a55`** / **3.5.29**; Soft Tip B **`sha-4a5c11e`** / **3.5.28**; Wave N **`sha-9072e0b`** / **3.5.10**. Low-RAM always (rule 0). Tracker: [`BUG_REPORT_WAVE_P.md`](../docs/operations/BUG_REPORT_WAVE_P.md).
