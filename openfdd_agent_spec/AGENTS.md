...
**Current ops pin (2026-09-12):** VERSION **3.5.6** · tip **`sha-e80237c`** · health **`3.5.6+e80237c0e758`** · `multi_tenant=false` · `active_tenant_id=legacy` · `tenant_budgets=false` · Wave L **3.5.6 PINNED**. Rollback: Wave K **`sha-9c3e8b1`** / **3.4.0**. Low-RAM always (rule 0).
