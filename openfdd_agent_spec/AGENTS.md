...
**Current ops pin (2026-09-04):** VERSION **3.3.21** — Overview/MQTT Zone Other / Metering honesty + x86 fieldbus → Railway hub. Stress: `run_railway_hub_stress.sh`. Template: [`PATCH_CYCLE.md`](../docs/operations/PATCH_CYCLE.md).
