...
**Current ops pin (2026-09-11):** VERSION **3.5.2** · tip **`sha-be65366`** · health **`3.5.2+be65366316bb`** · `multi_tenant=false` · Wave L **L3 LIVE**. Rollback: Wave K **`sha-9c3e8b1`** / **3.4.0**. Prior L2 **`sha-af08ac7`**. Low-RAM always (rule 0).
