...
**Current ops pin (2026-09-18):** VERSION **3.5.29** · tip **`sha-f727a55`** · health **`3.5.29+f727a55e01a4`** · `multi_tenant=true` · backup **`20260918T221510Z`** · hub stress **`reports/nightly-ot-bench_20260918T231541Z/`** **`fully_qualified=true`** (gates **19**+**35**+**25**/**25b** with `OPENFDD_SECURITY_EXECUTE=1`) · ACME fieldbus `sha-f727a55` · **OPS PINNED**. Prior Soft Tip B rollback: **`sha-4a5c11e`** / **3.5.28**. Wave N ACL baseline: **`sha-9072e0b`** / **3.5.10**. Low-RAM always (rule 0). Tracker: [`BUG_REPORT_WAVE_P.md`](../docs/operations/BUG_REPORT_WAVE_P.md). Harness stress-script follow-ups (QUAL order, Railway fixtures, ZAP dispositions, 25b 429) ship in the same-day tip train PR.
