...
**Current ops pin (2026-09-14):** VERSION **3.5.10** · tip **`sha-9072e0b`** · health **`3.5.10+9072e0b9fcf6`** · `multi_tenant=true` (authorized Stage C early waiver) · Wave N **OPS PINNED** (data-path `allow_building` + ACME MQTTS). Rollback: **`sha-1f94cdf`** / **3.5.9** or Wave M **`sha-0bfcd81`** / **3.5.7**. Low-RAM always (rule 0).
