...
| **Product hub pin** | Wave N **OPS PINNED** **`sha-9072e0b`** / **3.5.10** / health **`3.5.10+9072e0b9fcf6`** · `multi_tenant=true` · data-path `allow_building` · ACME MQTTS. Rollback **`sha-1f94cdf`** / **3.5.9** or **`sha-0bfcd81`** / **3.5.7**. |
