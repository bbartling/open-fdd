...
| **Product hub pin** | **FQ OPS PINNED** **`sha-7b81eb8`** / **3.5.31** · stress `20260919T195100Z` **`fully_qualified=true`** (Wave S1). **Smoke tip (no FQ):** **`sha-3cd3745`** / **3.5.33** · backup `20260919T231221Z` · health `3.5.33+3cd37451220a`. Prior: **`sha-f727a55`** / **3.5.29**. Soft Tip B: **`sha-4a5c11e`** / **3.5.28**. Wave N: **`sha-9072e0b`** / **3.5.10**. |
