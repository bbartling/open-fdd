...
7. Import with existing `POST /api/csv/import/package` + MCP `openfdd_csv_import_*` / `openfdd_csv_package_append`. Do **not** implement SCAFFOLD `mapping_suggest` / `package_preflight` this cycle.
