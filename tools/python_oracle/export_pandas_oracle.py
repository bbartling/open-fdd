...
SQL_TO_COOKBOOK: dict[str, str | None] = {
    ...
    "FC14": "FC14",
    "FC15": "FC15",
    "AHU-SATDEV": "AHU-SATDEV",
    "AHU-DUCTHI": "AHU-DUCTHI",
    "AHU-SIMUL-HEAT-COOL": "AHU-SIMUL",
    "ECON-3": "ECON-3",
    "OA-1": "OA-1",
    "DMP-1": "DMP-1",
    "VAV-3": "VAV-3",
...
RULE_KINDS: dict[str, list[str]] = {
    ...
    "ECON-4": ["ahu"],
    "ECON-5": ["ahu"],
    "PID-HUNT-1": ["ahu", "vav", "chiller", "boiler", "heatpump", "equip", "zone"],
    "SV-RANGE": ["ahu", "vav", "chiller", "boiler", "weather", "zone", "heatpump"],
    "SV-FLATLINE": ["ahu", "vav", "chiller", "boiler", "weather", "zone", "heatpump"],
    "SV-SPIKE": ["ahu", "vav", "chiller", "boiler", "weather", "zone", "heatpump"],
    "SV-STALE": ["ahu", "vav", "chiller", "boiler", "weather", "zone", "heatpump"],
    "SV-4": ["ahu"],
    "FC4": ["ahu"],
    "FC5": ["ahu"],
    "FC6": ["ahu"],
