...
from open_fdd.rules.cookbook_catalog import _f, _false, as_bool, norm_cmd
...
def resolve_web_drybulb_dewpoint(d: pd.DataFrame) -> tuple[pd.Series | None, pd.Series | None, str]:
    ...
    """
    from open_fdd.analytics.weather_psychrometrics import dewpoint_f_from_db_rh
...
def mechanical_proof_mask(d: pd.DataFrame, equipment_type: str = "", equipment_id: str = "") -> tuple[pd.Series, str]:
    ...
    from open_fdd.analytics.core import mech_cooling_run_mask
