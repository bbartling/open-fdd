...
class HelperUtils:
    ...
    def process_all_faults(self, df, config_dict):
            ...
            print("fc12 done")
            print("Supply air temperature too high; should be less than mix air temperature in economizer plus mech cooling mode")
            print("fault sum: ", fc12_faults)
            print("=" * 50)
            sys.stdout.flush()
            fault_counts["fc12_fault_sum"] = fc12_faults

            df_fc13 = fc12.apply(df.copy())
            fc13_faults = df_fc12["fc13_flag"].sum()
            print("fc13 done")
            print("Supply air temperature too high in full cooling in economizer plus mech cooling mode")
            print("fault sum: ", fc13_faults)
            print("=" * 50)
            sys.stdout.flush()
            fault_counts["fc13_fault_sum"] = fc13_faults
            ...
            del df_fc12
            df_combined["fc13_flag"] = df_fc12["fc13_flag"]
            del df_fc13
