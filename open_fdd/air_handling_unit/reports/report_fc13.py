...
class FaultCodeThirteenReport:
    ...
    def summarize_fault_times(self, df: pd.DataFrame, output_col: str = None) -> dict:
        ...
        summary = {
            ...
            'hours_fc13_mode': round((delta * df[output_col]).sum() / pd.Timedelta(hours=1)),
    ...
    def display_report_in_ipython(self, df: pd.DataFrame, output_col: str = "fc13_flag"):
        print("Fault Condition 13: Supply air temperature too high in full cooling in economizer plus mech cooling mode")
