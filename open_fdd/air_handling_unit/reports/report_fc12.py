...
class FaultCodeTwelveReport(BaseReport):
    ...
    def create_report(self, path: str, df: pd.DataFrame, output_col: str = None, report_name: str = "report_fc12.docx") -> None:
        if output_col is None:
            output_col = "fc12_flag"
        ...
        image_path = pkg_resources.resource_filename('open_fdd', 'air_handling_unit/images/fc12_definition.png')
