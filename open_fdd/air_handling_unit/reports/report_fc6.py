...
class FaultCodeSixReport:
    ...
    def summarize_fault_times(self, df: pd.DataFrame, output_col: str = None) -> dict:
        ...
        summary = {
            ...
            'hours_fc6_mode': round((delta * df[output_col]).sum() / pd.Timedelta(hours=1)),
    ...
    def display_report_in_ipython(self, df: pd.DataFrame, output_col: str = "fc6_flag"):
        ...
        print("Fault Condition 6: OA fraction too low or too high; should equal to design % outdoor air requirement")
