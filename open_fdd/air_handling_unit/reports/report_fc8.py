...
class FaultCodeEightReport:
    ...
    def summarize_fault_times(self, df: pd.DataFrame, output_col: str = None) -> dict:
        ...
        summary = {
            ...
            'hours_fc8_mode': round((delta * df[output_col]).sum() / pd.Timedelta(hours=1)),
    ...
    def display_report_in_ipython(self, df: pd.DataFrame, output_col: str = "fc8_flag"):
        print("Fault Condition 8: Supply air temperature and mix air temperature should be approximately equal in economizer mode")
