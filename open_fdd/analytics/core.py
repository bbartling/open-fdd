...
from open_fdd.analytics.runtime_intervals import hours_under_mask, interval_durations
...
def _discover_air_supply_fan(
    ...
    *,
    ...
    """
    from open_fdd.analytics.role_map import suggest_roles
...
def sensor_health_matrix(
    ...
    *,
    ...
    from open_fdd.rules.cookbook_catalog import SWEEP_SENSOR_ROLES, sensor_type_for_role as _stype
...
def plant_gated_summary_tables(
    ...
    """
    from open_fdd.analytics.rcx_plots import fan_mode_summary_bundle, pump_mode_summary_bundle
...
def economizer_weather_summary(
    ...
    *,
    ...
    from open_fdd.rules.economizer_weather import (
