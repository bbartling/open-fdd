...
mod tests {
    ...
    fn allows_select_from_telemetry_pivot() {
        let sql = "SELECT timestamp, equipment_id, oa_t, CASE WHEN oa_t > 100 THEN true ELSE false END AS fault_raw FROM telemetry_pivot WHERE equipment_id = 'equip:unit-a'";
