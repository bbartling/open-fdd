...
pub fn query_json() -> &'static str {
    r#"{"ok":true,"engine":"Apache Arrow RecordBatch / DataFusion query path","rows":[{"ts":"2026-06-21T00:00:00Z","point_id":"bacnet:1001:analog-input:1","value":55.0},{"ts":"2026-06-21T00:05:00Z","point_id":"bacnet:1001:analog-input:1","value":66.5}]}"#
}
