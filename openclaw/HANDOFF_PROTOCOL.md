...
Until a proper OpenClaw skill exists in `workspace/skills/`, treat **`openclaw/README.md` + this file** as the skill body. Prefer **git** for versioning (`openclaw/` commits).
