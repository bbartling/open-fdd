...
```bash
ansible-playbook -i openclaw/bench/fake_bacnet_devices/inventory.yml openclaw/bench/fake_bacnet_devices/fix_dpkg.yml
```
...
- **Inventory file:** `openclaw/bench/fake_bacnet_devices/inventory.yml`  
  - AHU: `192.168.204.13`  
  - VAV: `192.168.204.14`  
...
```bash
ansible-playbook -i openclaw/bench/fake_bacnet_devices/inventory.yml openclaw/bench/fake_bacnet_devices/playbook.yml
```

Or from this directory (`openclaw/bench/fake_bacnet_devices`):
